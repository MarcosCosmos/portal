...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CallbackSystem = __webpack_require__(3);

	var _Theme = __webpack_require__(72);

	var _Header = __webpack_require__(106);

	var _Box = __webpack_require__(104);

	var _ChildBox = __webpack_require__(127);

	var _ContainerBox = __webpack_require__(128);

	var _ContentBox = __webpack_require__(130);

	var _BoxLayoutManager = __webpack_require__(160);

	var _AddBoxButton = __webpack_require__(129);

	var _Popup = __webpack_require__(114);

	var _Page = __webpack_require__(116);

	var _ContentManager = __webpack_require__(103);

	var _ChatangoRoomManager = __webpack_require__(131);

	var _Encodable = __webpack_require__(95);
	...
	module.exports = {
		...
		Page: _Page.Page,
		Box: _Box.Box,
		ChildBox: _ChildBox.ChildBox,
		ContainerBox: _ContainerBox.ContainerBox,
		ContentBox: _ContentBox.ContentBox,
		BoxLayoutManager: _BoxLayoutManager.BoxLayoutManager,
		ChatangoRoomManager: _ChatangoRoomManager.ChatangoRoomManager,
		AddBoxButton: _AddBoxButton.AddBoxButton,
		Theme: _Theme.Theme,
		Popup: _Popup.Popup,
		CallbackSystem: _CallbackSystem.CallbackSystem,
		Encodable: _Encodable.Encodable,
		Core: _Core.Core
	}; /*
	...
	(0, _Encodable.setTypes)(module.exports);
...
/***/ function(module, exports, __webpack_require__) {
	...
	CallbackSystem.get = function (key) {
		if (typeof CallbackSystem.callbacks[key] !== 'undefined') {
			if (typeof CallbackSystem.callbacks[key].callback !== 'undefined') {
				return (0, _typeof3.default)(CallbackSystem.callbacks[key].callback);
			}
		}
		return false;
	};
	...
	CallbackSystem.setOnce = function (key, callback) {
		CallbackSystem.set(key, function () {
			callback();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Encodable2 = __webpack_require__(95);

	var _resources = __webpack_require__(96);
	...
	var CSSRule = function () {
		function CSSRule() {
			(0, _classCallCheck3.default)(this, CSSRule);

			this.selectors = [];
			this.properties = [];
		}

		(0, _createClass3.default)(CSSRule, [{
			key: 'addSelector',
			value: function addSelector(className) {
	...
	var Theme = function (_Encodable) {
		(0, _inherits3.default)(Theme, _Encodable);

		function Theme() {
			(0, _classCallCheck3.default)(this, Theme);

			var _this = (0, _possibleConstructorReturn3.default)(this, (Theme.__proto__ || (0, _getPrototypeOf2.default)(Theme)).call(this));

			_this.DOMRoot = $('<style>', {
				type: 'text/css',
				class: 'PortalApp-ThemeStylesheet'
			});
			_this.chatango = { roomType: null, styles: null };
			_this.cssText = '';
			_this.applyEncoding(_resources2.default.defaults.theme);
			return _this;
		}

		(0, _createClass3.default)(Theme, [{
			key: 'updateCSSText',
			value: function updateCSSText(cssText) {
			...
			value: function encode() {
				...
				var keys = (0, _keys2.default)(this.chatango.styles);
			...
			key: 'applyEncoding',
			value: function applyEncoding(encoding) {
			...
			key: 'setRoomType',
			value: function setRoomType(roomType) {
				this.chatango.roomType = roomType;
			}
		}, {
			key: 'setChatangoStyles',
			value: function setChatangoStyles(chatangoStyles) {
				if (!this.cssText) {
			...
			key: 'generateCSSTextFromChatangoStyles',
			value: function generateCSSTextFromChatangoStyles(chatangoStyles) {
				var rules = [];
			...
			key: 'getRBGAColorCode',
			value: function getRBGAColorCode(hex, alpha) {
				...
				if (!hex) {
					...
					var rgb = (0, _util.hexToRGB)(hex);
					return 'rgba(' + rgb.r + ', ' + rgb.g + ', ' + rgb.b + ', ' + alpha + ')';
				}
			}
		}, {
			key: 'getChatangoStyleByAlias',
			value: function getChatangoStyleByAlias(chatangoStyles, styleAlias) {
				var result = chatangoStyles[Theme.optionNameMap[styleAlias]];
				if (typeof result === 'undefined') {
					result = _resources2.default.defaults.theme.chatango.styles[Theme.optionNameMap[styleAlias]];
				}
				if (typeof result === 'undefined') {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var Encodable = function () {
		function Encodable() {
			(0, _classCallCheck3.default)(this, Encodable);
		}
	  ...
	  */
		...
		(0, _createClass3.default)(Encodable, [{
			key: "encode",
			value: function encode() {
				return {};
			}
	   ...
	   */
			...
			key: "constructFromEncoding",
			value: function constructFromEncoding(encoding) {
				var constructor = types[encoding.constructorName];
				var result = (0, _create2.default)(constructor.prototype);
	...
	module.exports = {
		Encodable: Encodable,
		setTypes: function setTypes(_types) {
			//this hack will retrospectively attach the full types list and then removes itself from the exports
			types = _types;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IframeManager = __webpack_require__(98);
	...
	module.exports = {
			...
			dark: {
				chatango: {
					...
					styles: (_styles = {
						...
						"showhdr": 0,
						"showx": 0
					}, (0, _defineProperty3.default)(_styles, 'cv', 0), (0, _defineProperty3.default)(_styles, "ticker", 0), (0, _defineProperty3.default)(_styles, "fwtickm", 0), (0, _defineProperty3.default)(_styles, "useonm", 1), (0, _defineProperty3.default)(_styles, "bottomPosition", "br"), _styles)
				}
			}
		},
		logo: '[New Logo Soon]',
		...
		viewModes: ['standard', 'edit', 'minimal'],
		defaults: {
			config: {
				settings: {
					defaultViewMode: 'standard',
					fallbackContentType: _IframeManager.IframeManager.contentType
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContentManager2 = __webpack_require__(103);

	var _Box = __webpack_require__(104);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var IframeManager = function (_ContentManager) {
		(0, _inherits3.default)(IframeManager, _ContentManager);

		function IframeManager(contentAddress) {
			(0, _classCallCheck3.default)(this, IframeManager);

			var _this = (0, _possibleConstructorReturn3.default)(this, (IframeManager.__proto__ || (0, _getPrototypeOf2.default)(IframeManager)).call(this));

			_this.DOMRoot.addClass('IframeManager');
			console.log(_this.DOMRoot);
			//auto size as the default setting, override when constructing from encoding
			if (contentAddress) {
				_this.setContent(contentAddress);
			}
			return _this;
		}
		...
		(0, _createClass3.default)(IframeManager, [{
			key: '_load',
			...
			key: 'setContent',
			value: function setContent(contentAddress) {
				console.log('isetchi');
			...
			key: 'encode',
			value: function encode() {
				var result = (0, _get3.default)(IframeManager.prototype.__proto__ || (0, _getPrototypeOf2.default)(IframeManager.prototype), 'encode', this).call(this);
			...
			key: 'applyEncoding',
			value: function applyEncoding(encoding) {
				(0, _get3.default)(IframeManager.prototype.__proto__ || (0, _getPrototypeOf2.default)(IframeManager.prototype), 'applyEncoding', this).call(this, encoding);
	   ...
	   */
			...
			key: 'getContentAddress',
			value: function getContentAddress() {
				//stub
				return IframeManager.contentType + ':' + (this.contentAddress ? this.contentAddress : '');
			}
		}]);
		return IframeManager;
	}(_ContentManager2.ContentManager);

	IframeManager.contentType = 'iframe';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContentManager = function (_Encodable) {
		(0, _inherits3.default)(ContentManager, _Encodable);

		function ContentManager(contentAddress) //note that all content managers are expected to use this param (and let it be optional) to optionally load some content on construction
		{
			(0, _classCallCheck3.default)(this, ContentManager);

			var _this = (0, _possibleConstructorReturn3.default)(this, (ContentManager.__proto__ || (0, _getPrototypeOf2.default)(ContentManager)).call(this));

			_this.DOMRoot = $('<div>', { class: 'ContentManager' });
	  ...
	  */
		...
		(0, _createClass3.default)(ContentManager, [{
			key: 'clean',
			...
			value: function destroy() {
				_Box.Box.prototype.destroy.call(this); //the standard box way also works here
			}
		}, {
			key: 'encode',
			value: function encode() {
				return (0, _get3.default)(ContentManager.prototype.__proto__ || (0, _getPrototypeOf2.default)(ContentManager.prototype), 'encode', this).call(this);
			}
		}, {
			key: 'applyEncoding',
			value: function applyEncoding(encoding) {
				(0, _get3.default)(ContentManager.prototype.__proto__ || (0, _getPrototypeOf2.default)(ContentManager.prototype), 'applyEncoding', this).call(this, encoding);
	...
	ContentManager.contentType = 'demo-content-type';
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var Box = function (_Encodable) {
	    (0, _inherits3.default)(Box, _Encodable);

	    function Box() {
	        (0, _classCallCheck3.default)(this, Box);
	        return (0, _possibleConstructorReturn3.default)(this, (Box.__proto__ || (0, _getPrototypeOf2.default)(Box)).call(this));
	    }
	    ...
	    (0, _createClass3.default)(Box, [{
	        key: 'reloadContents',
	        value: function reloadContents() //default method, safe to use but doesn't do anything
	        {}
	    }, {
	        key: 'destroy',
	        value: function destroy() {
	        ...
	        key: 'lockLayout',
	        value: function lockLayout() {}
	    }, {
	        key: 'unlockLayout',
	        value: function unlockLayout() {}
	    }], [{
	        key: 'lockElms',
	        value: function lockElms(targetElms) {
	        ...
	        key: 'unlockElms',
	        value: function unlockElms(targetElms) {
	            targetElms.each(function () {
	                var locks = $(this).data('enableLocks');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    selectElm: selectElm,
	    mixin: mixin,
	    delayUntilTriggeredRepeatedly: delayUntilTriggeredRepeatedly
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _menuControls = __webpack_require__(113);

	var _credits = __webpack_require__(115);

	var _import = __webpack_require__(118);

	var _share = __webpack_require__(119);

	var _info3 = __webpack_require__(126);
	 ...
	 */
	var Header = function () {
		function Header(appCore) {
			(0, _classCallCheck3.default)(this, Header);

			this.appCore = appCore;
			this.controls = [];
			this.pages = [];
			var versionComponents = _info2.default.version.split('-');

			this.DOMRoot = $('<div>', {
				class: 'header overlay'
			});

			var headerSubWrapper = $('<div>', {
			...
			logoElm.append(_resources2.default.logo);
			...
			var versionElm = $('<span>', {
				class: 'version',
				html: 'v' + _info2.default.version
			});
			infoElm.append(versionElm);

			var flavorElm = $('<span>', {
				class: 'flavorText',
				html: _info2.default.flavorText
			});
			...
			//generate controls
			this.addControls(_menuControls.controlGenerators);

			//generate the pages
			this.addPages([_credits.pageGenerator, _import.pageGenerator, _share.pageGenerator, _info3.pageGenerator]);
		}
	  ...
	  */
		...
		(0, _createClass3.default)(Header, [{
			key: 'addControls',
			value: function addControls(controlGenerators) {
				...
				try {
					for (var _iterator = (0, _getIterator3.default)(controlGenerators), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						var eachGen = _step.value;

						var eachResult = eachGen(this.appCore);
	   ...
	   */
			...
			key: 'addPages',
			value: function addPages(pageGenerators) {
				...
				try {
					for (var _iterator2 = (0, _getIterator3.default)(pageGenerators), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
						var eachGen = _step2.value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var controlGenerators = [
	/*saveConfigurationButton*/function (appCore) {
		return $('<button>', {
			type: 'button',
	...
	/*layoutEditButton*/function (appCore) {
		...
		_CallbackSystem.CallbackSystem.set('viewModeUpdated', updateEditButtonText);
		return editButton;
	},

	/*minimalViewButton*/function (appCore) {
		return $('<button>', {
			type: 'button',
	...
	/*configResetButton*/function (appCore) {
		return $('<button>', {
			type: 'button',
		...
		function () {
			...
			var resetPrompt = new _Popup.Popup();
			resetPrompt.close = function () {
				resetPrompt.DOMRoot.detach();
				_Popup.Popup.removeOpenPopup(resetPrompt);
				promptOpen = false;
			};
			resetPrompt.setContent(['Are you sure you want to clear the configuration?', '</br>', '(Note: This will also delete your saved settings).', '</br>', '</br>', $('<button>', {
			...
			return function () {
				if (!promptOpen) {
					...
					_Popup.Popup.addOpenPopup(resetPrompt);
				}
			};
		}());
	},

	/*reloadLayoutContentsButton*/function (appCore) {
		return $('<button>', {
			type: 'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Popup = function () {
		...
		function Popup(content) {
			...
			this.mainDiv.append(this.controls);

			this.contentSection = $('<div>', {
				class: 'popupContentSection'
			});

			this.mainDiv.append(this.contentSection);
	  ...
	  */
		...
		(0, _createClass3.default)(Popup, [{
			...
			value: function addOpenPopup(popup, index) {
			...
			key: 'closeTopPopupIfExisting',
			value: function closeTopPopupIfExisting() {
			...
			key: 'removeOpenPopup',
			value: function removeOpenPopup(target) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var creditsHTMLPage = __webpack_require__(117); //let creditsHTMLPage = require('file?emitFile=false&name=[name].[ext]!./credits.html');

	//this will need to be fixed so that the page can actually load
	module.exports = {
		pageGenerator: function pageGenerator(appCore) {
			var Credits = new _Page.Page('&copy;Marcos C-S, 2016', $('<iframe>', {
				src: creditsHTMLPage + '#',
			...
			Credits.refresh = function () {
				this.content.attr('src', creditsHTMLPage + '#' + (0, _util.compileURL)({ themeCSS: $('.PortalApp-ThemeStylesheet').text() }));
			};
			return Credits;
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var Page = function (_Popup) {
		(0, _inherits3.default)(Page, _Popup);

		function Page(pageName, content) {
			(0, _classCallCheck3.default)(this, Page);

			var _this = (0, _possibleConstructorReturn3.default)(this, (Page.__proto__ || (0, _getPrototypeOf2.default)(Page)).call(this, content));

			_this.DOMRoot.addClass('page');
			_this.name = pageName;
			_this.navItem = _this.navItem = $('<button>', {
				class: 'pageNavItem buttonRule',
				html: _this.name,
				'data-selected': false
			});
			var self = _this;
			_this.navItem.on('click', function () {
				self.open();
			});
		...
		(0, _createClass3.default)(Page, [{
			...
			value: function open() {
				...
				_Popup2.Popup.addOpenPopup(this, 0);
			}
		}, {
			key: 'close',
			value: function close() {
				...
				_Popup2.Popup.removeOpenPopup(this);
			}
		}, {
			key: 'refresh',
			...
			key: '_setOpenPage',
			value: function _setOpenPage(page) {
			...
			key: 'refreshOpenPage',
			value: function refreshOpenPage() {
				if (Page._openPage != null) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "credits.html";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		pageGenerator: function pageGenerator(appCore) {
			var importPage = new _Page.Page('Import/Customise');
			importPage.importForm = $('<form>', {
				class: 'importForm'
			});
			importPage.mainInput = $('<textarea>', {
				class: 'importTextArea fieldRule',
				placeholder: 'Enter config text here.'
			});

			importPage.submitButton = $('<button>', {
				type: 'submit',
				class: 'buttonRule',
				text: 'Submit'
			});

			importPage.importForm.append('Please enter below a configuration, such as a JSON-string from the share page or a chatroom embed code from ', $('<a>', {
				href: '//quadgrouple.chatango.com/clonegroup',
				target: '_blank',
				text: 'chatango.com/clonegroup'
			}), ':', '<br/>', importPage.mainInput, '<br/>', $('<em>', {
			...
			}), '<br/>', importPage.submitButton, '<br/>', 'Additionally, note that only the theme is taken from clonegroup, the chatroom being cloned will not be added to the layout.', '<br/>', '<br/>', 'Hint (New): You can now add things like background images, whatever you want aethetically more or less by adding custom CSS rules to a JSON-string for your configuration (for a template, you can get the JSON for the current configuration from the share page), just set the \'cssText\' property of the style object to a string containing your css rules!');
			...
			importPage.importForm.on('submit', processImportForm);
			importPage.importForm.find(':input').on('keypress', function (event) {
				if (event.keyCode == 13) {
					processImportForm();
				}
			});
		...
		pageGenerator: function pageGenerator(appCore) {
			...
			sharePage.updateShareText = function () {
				if (this.idsAreReady) {
					...
					switch (this.shareType) {
						case 0:
							link = link + (0, _util.compileURL)({ themeID: this.themeID, layoutID: this.layoutID });
							break;
						case 1:
							link = link + (0, _util.compileURL)({ themeID: this.themeID });
							break;
						case 2:
							link = link + (0, _util.compileURL)({ layoutID: this.layoutID });
							break;
						default:
					}
			...
			sharePage.refresh = function () {
				if (this.isOpen) {
					...
					(0, _assign2.default)(themePlusSettingsObj, this.config);
					delete themePlusSettingsObj.layout;
					this.configText = (0, _stringify2.default)(this.config);
					this.themeText = (0, _stringify2.default)(themePlusSettingsObj);
					this.layoutText = (0, _stringify2.default)(this.config.layout);
					this.themeID = null;
					this.layoutID = null;
					var self = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		pageGenerator: function pageGenerator(appCore) {
			var Info = new _Page.Page('Instructions & Info', '');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Box2 = __webpack_require__(104);
	...
	var ChildBox = function (_Box) {
		(0, _inherits3.default)(ChildBox, _Box);

		function ChildBox(parent) {
			(0, _classCallCheck3.default)(this, ChildBox);

			var _this = (0, _possibleConstructorReturn3.default)(this, (ChildBox.__proto__ || (0, _getPrototypeOf2.default)(ChildBox)).call(this));

			_this.parent = typeof parent !== 'undefined' ? parent : null;
			_this.DOMRoot = $('<div>', { class: 'ChildBox' });
			return _this;
		}

		(0, _createClass3.default)(ChildBox, [{
			key: 'setParent',
			value: function setParent(box) {
				this.parent = box;
			}
	   ...
	   */
			...
			value: function destroy() {
				...
				(0, _get3.default)(ChildBox.prototype.__proto__ || (0, _getPrototypeOf2.default)(ChildBox.prototype), 'destroy', this).call(this);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChildBox2 = __webpack_require__(127);
	...
	var ContainerBox = function (_ChildBox) {
		(0, _inherits3.default)(ContainerBox, _ChildBox);

		function ContainerBox(boxType) {
			(0, _classCallCheck3.default)(this, ContainerBox);

			var _this = (0, _possibleConstructorReturn3.default)(this, (ContainerBox.__proto__ || (0, _getPrototypeOf2.default)(ContainerBox)).call(this));

			_this.DOMRoot.addClass('ContainerBox outerOfPair'); //different to the lowercase class? idk, might have to rename something.
			//an inner div is important to ensure the boxes are stretched properly in both directions
			_this.mainDiv = $('<div>', {
				class: 'ContainerBox innerOfPair'
			}).appendTo(_this.DOMRoot);

			_this.initialAddButton = new _AddBoxButton.AddBoxButton();
			_this.initialAddButton.setup(_this);
			_this.boxes = [];
			_this.mainDiv.append(_this.initialAddButton.DOMRoot);

			_this.autoSizeButton = $('<button>', {
				type: 'button',
			...
			var self = _this;
			_this.autoSizeButton.on('click', function () {
				self.enableAutoSizing();
			});
			_this.resizeElm = $('<div>', {
				class: 'boxResizeElm'
			});
			_this.resizeElm.append(_this.autoSizeButton);
			_this.resizeElm.resizable({
				disabled: true,
				handles: 'n, s, e, w',
		...
		(0, _createClass3.default)(ContainerBox, [{
			...
			key: 'disableManualSizing',
			value: function disableManualSizing() {
			...
			value: function enableAutoSizing() {
				this.autoSize = true;
				...
				this.resizeElm.find('.ui-resizable-handle').one('mousedown', onMouseDownInitializer);
			}
		}, {
			key: 'disableAutoSizing',
			value: function disableAutoSizing() {
				this.autoSize = false;
			...
			key: 'setBoxType',
			value: function setBoxType(boxType) {
				var altBoxType;
				var resizeHandlers;
	   ...
	   */
			...
			key: 'getEntryIndex',
			value: function getEntryIndex(targetBox) {
	   ...
	   */
			...
			key: 'add',
			value: function add(box, index) {
				index = typeof index !== 'undefined' ? index : _AddBoxButton.AddBoxButton.prototype.indexRetreiver();
				var entry = { box: box, addBeforeButton: new _AddBoxButton.AddBoxButton() };
				...
				entry.addBeforeButton.setup(this, function () {
					return self.boxes.indexOf(entry);
				});
	   ...
	   */
			...
			key: '_wrapInAltContainer',
			value: function _wrapInAltContainer(box) {
	   ...
	   */
			...
			key: 'unwrapIfOnlyChild',
			value: function unwrapIfOnlyChild() {
	   ...
	   */
			...
			key: 'collapseIfAppropriate',
			value: function collapseIfAppropriate() {
	   ...
	   */
			...
			key: 'populateFromEncodings',
			value: function populateFromEncodings(encodings) {
				var eachEncoding;
	   ...
	   */
			...
			key: 'populateFromEncoding',
			value: function populateFromEncoding(encoding) {
				this.add(_Encodable.Encodable.constructFromEncoding(encoding));
			}
	   ...
	   */
			...
			key: 'lockLayout',
			value: function lockLayout() {
				_Box.Box.lockElms(this.mainDiv.children('.addBoxButton'));
				for (var i = 0; i < this.boxes.length; i++) {
					this.boxes[i].box.lockLayout();
				}
				(0, _get3.default)(ContainerBox.prototype.__proto__ || (0, _getPrototypeOf2.default)(ContainerBox.prototype), 'lockLayout', this).call(this);
			}
		}, {
			key: 'unlockLayout',
			value: function unlockLayout() {
				_Box.Box.unlockElms(this.mainDiv.children('.addBoxButton'));
				for (var i = 0; i < this.boxes.length; i++) {
					this.boxes[i].box.unlockLayout();
				}
				(0, _get3.default)(ContainerBox.prototype.__proto__ || (0, _getPrototypeOf2.default)(ContainerBox.prototype), 'unlockLayout', this).call(this);
			}
		}, {
			key: 'encode',
			value: function encode() {
				var result = (0, _get3.default)(ContainerBox.prototype.__proto__ || (0, _getPrototypeOf2.default)(ContainerBox.prototype), 'encode', this).call(this);
			...
			value: function destroy() {
				this.clear();
				(0, _get3.default)(ContainerBox.prototype.__proto__ || (0, _getPrototypeOf2.default)(ContainerBox.prototype), 'destroy', this).call(this);
			}
		}, {
			key: 'applyEncoding',
			value: function applyEncoding(encoding) {
				(0, _get3.default)(ContainerBox.prototype.__proto__ || (0, _getPrototypeOf2.default)(ContainerBox.prototype), 'applyEncoding', this).call(this, encoding);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var AddBoxButton = function () {
		function AddBoxButton() {
			(0, _classCallCheck3.default)(this, AddBoxButton);
			...
			this.DOMRoot[0].addEventListener('drop', function (event) {
				self.onDrop(event);
			});
			//indicate this is a dropable zone
			this.DOMRoot[0].addEventListener('dragenter', function (event) {
				event.preventDefault();
			});
			this.DOMRoot[0].addEventListener('dragover', function (event) {
				event.preventDefault();
			});
		}
		...
		(0, _createClass3.default)(AddBoxButton, [{
			key: 'indexRetreiver',
			value: function indexRetreiver() {
				return -1;
			}
	   ...
	   */
			...
			key: 'setup',
			value: function setup(parent, indexRetreiver) {
				this.parent = parent;
	   ...
	   */
			...
			key: 'attachToParent',
			value: function attachToParent(box) {
			...
			value: function onClick() {
				this.attachToParent(new _ContentBox.ContentBox());
			}
		}, {
			key: 'onDrop',
			value: function onDrop(event) {
				...
				this.attachToParent(_Encodable.Encodable.constructFromEncoding(encoding));
				event.preventDefault();
			}
		}]);
		return AddBoxButton;
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var ContentBox = function (_ChildBox) {
		(0, _inherits3.default)(ContentBox, _ChildBox);

		function ContentBox(contentManagerOrAddress) {
			(0, _classCallCheck3.default)(this, ContentBox);

			var _this = (0, _possibleConstructorReturn3.default)(this, (ContentBox.__proto__ || (0, _getPrototypeOf2.default)(ContentBox)).call(this));

			_this.DOMRoot.addClass('ContentBox outerBorderRule');

			_this.controls = $('<div>', {
				class: 'ContentBoxControls'
			});
			_this.DOMRoot.append(_this.controls);

			_this.contentInput = $('<input/>', {
				class: 'contentInput fieldRule',
				placeholder: '(content-type:)?URL' //eventually to support configs directly
			});

			_this.controls.append(_this.contentInput);
			_this.contentSubmitButton = $('<button>', {
				type: 'button',
				class: 'contentGoButton buttonRule',
				text: 'Go'
			});
			_this.controls.append(_this.contentSubmitButton);
			...
			_this.dragElm.append($('<div>', {
				class: 'antiSelectionCover'
			}));
			_this.controls.append(_this.dragElm);

			_this.deleteButton = $('<button>', {
				type: 'button',
				class: 'deleteButton buttonRule',
				text: 'x'
			});

			_this.deleteButton.data('enableLocks', 0); //default enableLocks to none.
			_this.controls.append(_this.deleteButton);
			var self = _this;

			_this.contentInput.on('keypress', function (event) {
				if (event.keyCode == 13) {
					_this.setContent(_this.contentInput.val());
				}
			});

			_this.contentSubmitButton.on('click', function (event) {
				_this.setContent(_this.contentInput.val());
			});
			...
			_this.dragElm[0].addEventListener('mousedown', function (event) {
				if (event.button == 1) {
			...
			_this.dragElm[0].addEventListener('dragstart', function (event) {
				//add a disable lock to inputs so this doesn't get dropped into them on ff
				_Box.Box.lockElms($('input'));
				event.dataTransfer.effectsAllowed = 'move';
				event.dataTransfer.setData('BoxJSONString', (0, _stringify2.default)(self.encode()));
			...
			_this.dragElm[0].addEventListener('dragend', function (event) {
				...
				_Box.Box.unlockElms($('input'));
			});

			_this.deleteButton.on('click', function () {
				self.destroy();
			});
			_this.embedSection = $('<div>', {
				class: 'contentEmbed'
			});
			_this.DOMRoot.append(_this.embedSection);

			_this.setParent(null);
			switch (typeof contentManagerOrAddress === 'undefined' ? 'undefined' : (0, _typeof3.default)(contentManagerOrAddress)) {
				case 'function':
			...
			ContentBox.addContentBox(_this);
			return _this;
		}
	  ...
	  */
		...
		(0, _createClass3.default)(ContentBox, [{
			key: 'reloadContents',
			value: function reloadContents() {
			...
			value: function destroy() {
				...
				(0, _get3.default)(ContentBox.prototype.__proto__ || (0, _getPrototypeOf2.default)(ContentBox.prototype), 'destroy', this).call(this);
				ContentBox.removeContentBox(this);
			}
		}, {
			key: 'encode',
			value: function encode() {
				var result = (0, _get3.default)(ContentBox.prototype.__proto__ || (0, _getPrototypeOf2.default)(ContentBox.prototype), 'encode', this).call(this);
			...
			key: 'applyEncoding',
			value: function applyEncoding(encoding) {
				(0, _get3.default)(ContentBox.prototype.__proto__ || (0, _getPrototypeOf2.default)(ContentBox.prototype), 'applyEncoding', this).call(this, encoding);
				if (encoding.contentManager) {
					this.setContentManager(_Encodable.Encodable.constructFromEncoding(encoding.contentManager));
				}
			}
	   ...
	   */
			...
			value: function lockContent() {
				_Box.Box.lockElms($([this.contentInput, this.contentSubmitButton]));
			}
	   ...
	   */
			...
			value: function unlockContent() {
				_Box.Box.unlockElms($([this.contentInput, this.contentSubmitButton]));
			}
		}, {
			key: 'lockLayout',
			value: function lockLayout() {
				(0, _get3.default)(ContentBox.prototype.__proto__ || (0, _getPrototypeOf2.default)(ContentBox.prototype), 'lockLayout', this).call(this);
				_Box.Box.lockElms(this.DOMRoot.find('.deleteButton'));
				this.dragElm.attr('draggable', false);
			}
		}, {
			key: 'unlockLayout',
			value: function unlockLayout() {
				(0, _get3.default)(ContentBox.prototype.__proto__ || (0, _getPrototypeOf2.default)(ContentBox.prototype), 'unlockLayout', this).call(this);
				_Box.Box.unlockElms(this.DOMRoot.find('.deleteButton'));
			...
			value: function setContent(contentAddress) {
				...
				if (!nextContentManagerType) {
					...
					if (/\.chatango\.com$/.test(contentAddress)) {
						nextContentManagerType = _ChatangoRoomManager.ChatangoRoomManager;
			...
			key: 'updateAddressFeild',
			value: function updateAddressFeild() {
				this.contentInput.val(this.contentManager.getContentAddress());
			}
		}], [{
			key: 'addContentBox',
			value: function addContentBox(contentBox) {
	   ...
	   */
			...
			key: 'removeContentBox',
			value: function removeContentBox(contentBox) {
				var targetButton;
				var locks;
			...
			key: 'determineContentManagerType',
			value: function determineContentManagerType(contentType) {
				switch (contentType) {
					case 'chatango-room':
						return _ChatangoRoomManager.ChatangoRoomManager;
					case 'iframe':
						return _IframeManager.IframeManager;
					default:
						return false;
				}
			}
	   ...
	   */
			...
			key: 'lockAllContents',
			value: function lockAllContents() {
				var _iteratorNormalCompletion = true;
				var _didIteratorError = false;
				var _iteratorError = undefined;

				try {
					for (var _iterator = (0, _getIterator3.default)(ContentBox._contentBoxes), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			...
			key: 'unlockAllContents',
			value: function unlockAllContents() {
				var _iteratorNormalCompletion2 = true;
				var _didIteratorError2 = false;
				var _iteratorError2 = undefined;

				try {
					for (var _iterator2 = (0, _getIterator3.default)(ContentBox._contentBoxes), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var scriptIDPrefix = 'cid00' + '20000000000000'; //the last + is a random number btw
	...
	var ChatangoRoomManager = function (_ContentManager) {
		(0, _inherits3.default)(ChatangoRoomManager, _ContentManager);

		function ChatangoRoomManager(contentAddress) {
			(0, _classCallCheck3.default)(this, ChatangoRoomManager);

			var _this = (0, _possibleConstructorReturn3.default)(this, (ChatangoRoomManager.__proto__ || (0, _getPrototypeOf2.default)(ChatangoRoomManager)).call(this));

			_this.DOMRoot.addClass('ChatangoRoomManager');
			//auto size as the default setting, override when constructing from encoding
			_this.setContent(contentAddress);
			return _this;
		}

		(0, _createClass3.default)(ChatangoRoomManager, [{
			key: '_load',
			value: function _load() {
				var script = $('<script>', {
	   ...
	   */
			...
			key: 'encode',
			value: function encode() {
				var result = (0, _get3.default)(ChatangoRoomManager.prototype.__proto__ || (0, _getPrototypeOf2.default)(ChatangoRoomManager.prototype), 'encode', this).call(this);
				//remove boxType from the encoding as it would go unused, sinzce this class consistantly uses the same box type, stored as "static" data (on the constructor).
			...
			key: 'applyEncoding',
			value: function applyEncoding(encoding) {
				(0, _get3.default)(ChatangoRoomManager.prototype.__proto__ || (0, _getPrototypeOf2.default)(ChatangoRoomManager.prototype), 'applyEncoding', this).call(this, encoding);
	   ...
	   */
			...
			key: 'extractGroupID',
			value: function extractGroupID(contentAddress) {
	...
	ChatangoRoomManager.contentType = 'chatango-room';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;( function( factory ) {
		if ( true ) {
			...
			// AMD. Register as an anonymous module.
			!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(73), __webpack_require__(136) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
		} else {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var BoxLayoutManager = function (_Encodable) {
		(0, _inherits3.default)(BoxLayoutManager, _Encodable);

		function BoxLayoutManager(preventDefault) {
			(0, _classCallCheck3.default)(this, BoxLayoutManager);

			var _this = (0, _possibleConstructorReturn3.default)(this, (BoxLayoutManager.__proto__ || (0, _getPrototypeOf2.default)(BoxLayoutManager)).call(this));

			_this.DOMRoot = $('<div>', {
				class: 'BoxLayoutManager'
			});
			_this._defaultInitialize();
			return _this;
		}

		(0, _createClass3.default)(BoxLayoutManager, [{
			key: 'reset',
	   ...
	   */
			...
			key: 'startMonitoringAddFor',
			value: function startMonitoringAddFor(box) {
				var self = this;
	   ...
	   */
			...
			key: 'stopMonitoringAddFor',
			value: function stopMonitoringAddFor(box) {
				box.add = _ContainerBox.ContainerBox.prototype.add;
			}
		}, {
			key: 'startMonitoringCollapseIfAppropriateFor',
			value: function startMonitoringCollapseIfAppropriateFor(box) {
				var self = this;
			...
			key: 'stopMonitoringCollapseIfAppropriateFor',
			value: function stopMonitoringCollapseIfAppropriateFor(box) {
				box.collapseIfAppropriate = _ContainerBox.ContainerBox.prototype.collapseIfAppropriate;
			}
	   ...
	   */
			...
			key: '_defaultInitialize',
			value: function _defaultInitialize() {
				this.containerBox = new _ContainerBox.ContainerBox('row');
				var target = new _ContainerBox.ContainerBox('column');
			...
			key: 'enableLayoutEditing',
			value: function enableLayoutEditing() {
				this.containerBox.unlockLayout();
				this.DOMRoot.attr('data-editing-enabled', true);
				this.editingEnabled = true;
			}
		}, {
			key: 'disableLayoutEditing',
			value: function disableLayoutEditing() {
			...
			key: 'onAdd',
			value: function onAdd(eventSource, box, index) {
				if (eventSource == this.containerBox && this.containerBox.boxes.length == 1) {
					if (!(eventSource.boxes[0].box instanceof _ContainerBox.ContainerBox)) {
					...
					for (var i = 0; i < eventSource.boxes.length; i++) {
						...
						if (eachBox instanceof _ContainerBox.ContainerBox) {
					...
					this.containerBox = new _ContainerBox.ContainerBox(nextBoxType);
					this.DOMRoot.append(this.containerBox.DOMRoot);
					this.startMonitoringAddFor(this.containerBox); //it's important to monitor before the initial add is performed.
					this.containerBox.add(eventSource);
				}
				_ContainerBox.ContainerBox.prototype.add.call(eventSource, box, index);
			}
		}, {
			key: 'onCollapseIfAppropriate',
			value: function onCollapseIfAppropriate(eventSource) {
				if (!_ContainerBox.ContainerBox.prototype.collapseIfAppropriate.call(eventSource) && eventSource.parent == this.containerBox && this.containerBox.boxes.length == 1 && eventSource.boxes.length == 1 && eventSource.boxes[0].box instanceof _ContainerBox.ContainerBox && eventSource.boxes[0].box.boxType == this.containerBox.boxType && eventSource.boxes[0].box.boxes.length > 1) {
			...
			key: 'encode',
			value: function encode() {
				var result = (0, _get3.default)(BoxLayoutManager.prototype.__proto__ || (0, _getPrototypeOf2.default)(BoxLayoutManager.prototype), 'encode', this).call(this);
			...
			value: function applyEncoding(encoding) {
				if (typeof encoding.containerBox !== 'undefined') {
					this.containerBox.destroy();
					this.containerBox = _Encodable2.Encodable.constructFromEncoding(encoding.containerBox);
					this.startMonitoringAddFor(this.containerBox);
					for (var i = 0; i < this.containerBox.boxes.length; i++) {
						var eachBox = this.containerBox.boxes[i].box;
						if (eachBox instanceof _ContainerBox.ContainerBox) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Core = function () {
	    ...
	    function Core(config, prioritiseUserConfig, DOMRoot, callback) {
	        var _this = this;
	        ...
	        $(window).on('keypress', function (e) {
	            if (e.keyCode == 27) {
	                _Popup.Popup.closeTopPopupIfExisting();
	            }
	        });

	        this.header = new _Header.Header(this); //header will generate it's contents
	        this.DOMRoot.append(this.header.DOMRoot);

	        //generate the theme
	        this.theme = new _Theme.Theme();
	        ...
	        _ChatangoRoomManager.ChatangoRoomManager.prototype.theme = this.theme.chatango;

	        //the other stuff
	        this.boxLayoutManager = new _BoxLayoutManager.BoxLayoutManager();
	        this.boxLayoutManager._saveConfiguration = function () {
	            this.saveConfiguration();
	        }; //override/assign it a function for doing the saving that uses the one in self class.
	        ...
	        if (prioritiseUserConfig == true) {
	            this.tryUrlConfig(function (success) {
	                if (success) {
	                    ...
	                    if (!_this.loadSavedConfiguration()) {
	                        if (config) {
	                            if (!_this.loadConfiguration(config)) {
	                                ...
	                                _this.loadConfiguration(_resources2.default.defaults.config);
	                                _this.setViewMode('edit');
	                            }
	                        } else {
	                            _this.loadConfiguration(_resources2.default.defaults.config);
	                            _this.setViewMode('edit');
	            ...
	            if (config) {
	                if (!this.loadConfiguration(config)) {
	                    console.log('Notice: Core (constructor): an error occured whilst loading the configuration, will now try to load the default configuration.');
	                    this.loadConfiguration(_resources2.default.defaults.config);
	    ...
	    (0, _createClass3.default)(Core, [{
	        key: 'compileConfiguration',
	        value: function compileConfiguration() {
	            var config = {};
	        ...
	        key: 'compileConfigurationIntoURLQuery',
	        value: function compileConfigurationIntoURLQuery() {
	            var result;
	            var config = this.compileConfiguration();
	            return encodeURIComponent((0, _stringify2.default)(config));
	        }
	    }, {
	        key: 'saveConfiguration',
	        value: function saveConfiguration() {
	            var config = (0, _stringify2.default)(this.compileConfiguration());
	        ...
	        key: 'tryUrlConfig',
	        value: function tryUrlConfig(callback) {
	            var self = this;
	            var success = false;
	            var data = {};
	            ...
	            if (hash.length > 0) {
	                ...
	                (function () {
	                    var tryConfigAjaxWithStandardError = function tryConfigAjaxWithStandardError(URL, procedure) {
	                        $.ajax({
	                            url: URL
	                        }).done(function (data) {
	                            try {
	                    ...
	                    config = {};
	                    urlData = _util2.default.parseURL(hash.slice(1));

	                    if (typeof urlData.themeID !== 'undefined') {
	                        tryConfigAjaxWithStandardError('https://api-ssl.bitly.com/v3/expand?format=txt&access_token=e1824c0eb367227b87c223718f83e5997092034e&hash=' + urlData.themeID, function (data) {
	                            config.settings = data.settings;
	                            config.theme = data.theme;
	                            if (typeof urlData.layoutID !== 'undefined') {
	                                tryConfigAjaxWithStandardError('https://api-ssl.bitly.com/v3/expand?format=txt&access_token=e1824c0eb367227b87c223718f83e5997092034e&hash=' + urlData.layoutID, function (data) {
	                                    config.layout = data;
	                        ...
	                        tryConfigAjaxWithStandardError('https://api-ssl.bitly.com/v3/expand?format=txt&access_token=e1824c0eb367227b87c223718f83e5997092034e&hash=' + urlData.configID, function (data) {
	                            config = data;
	                            //load the config even if it's undefined, since the function would then attempt to get it from localStorage.
	                            self.loadConfiguration(config);
	                            success = true;
	        ...
	        key: 'loadSavedConfiguration',
	        value: function loadSavedConfiguration() {
	            var _this2 = this;

	            var clearConfigWithNotice = function clearConfigWithNotice() {
	        ...
	        value: function loadConfiguration(config) {
	            try {
	                //set defaults where data is missing.
	                config.settings = typeof config.settings !== 'undefined' ? config.settings : _resources2.default.defaults.config.settings;
	                config.settings.defaultViewMode = typeof config.settings.defaultViewMode !== 'undefined' ? config.settings.defaultViewMode : _resources2.default.defaults.config.settings.defaultViewMode;
	                config.settings.fallbackContentType = typeof config.settings.fallbackContentType !== 'undefined' ? config.settings.fallbackContentType : _resources2.default.defaults.config.settings.fallbackContentType;
	                config.theme = typeof config.theme !== 'undefined' ? config.theme : _resources2.default.defaults.theme;
	                config.theme.chatango.roomType = typeof config.theme.chatango.roomType !== 'undefined' ? config.theme.chatango.roomType : _resources2.default.defaults.theme.chatango.roomType;
	                config.theme.chatango.styles = typeof config.theme.chatango.styles !== 'undefined' ? config.theme.chatango.styles : _resources2.default.defaults.theme.chatango.styles;
	                ...
	                _ContentBox.ContentBox.prototype.fallbackContentManager = _ContentBox.ContentBox.determineContentManagerType(this.settings.fallbackContentType);
	                return true;
	            } catch (e) {
	        ...
	        key: 'clearConfiguration',
	        value: function clearConfiguration() {
	            localStorage.removeItem('the_portal/configuration');
	            this.boxLayoutManager.reset();
	            this.loadConfiguration(_resources2.default.defaults.config);
	            this.setViewMode('edit');
	            _CallbackSystem.CallbackSystem.trigger('configUpdated');
	        }
	    }, {
	        key: 'setViewMode',
	        value: function setViewMode(targetMode) {
	            switch (targetMode) {
	                case this.viewMode:
	                    //do nothing if we're already in this mode.
	                    break;
	                case 'edit':
	                    switch (this.viewMode) {
	                        case 'minimal':
	                            _ContentBox.ContentBox.unlockAllContents();
	                        case 'standard':
	                ...
	                case 'minimal':
	                    switch (this.viewMode) {
	                        case 'edit':
	                            this.boxLayoutManager.disableLayoutEditing();
	                        case 'standard':
	                            _ContentBox.ContentBox.lockAllContents();
	                            break;
	                        default:
	                            this.boxLayoutManager.disableLayoutEditing();
	                    }
	            ...
	            _CallbackSystem.CallbackSystem.trigger('viewModeUpdated');
	        }
	    }]);
	    return Core;
	}();

	_CallbackSystem.CallbackSystem.set('configUpdated', function () {
	    _Page.Page.refreshOpenPage();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// fallback for IE11 buggy Object.getOwnPropertyNames with iframe and window
	var toIObject = __webpack_require__(193)
	  , gOPN      = __webpack_require__(211).f
	  , toString  = {}.toString;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(169);
	// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
	$export($export.S + $export.F * !__webpack_require__(167), 'Object', {defineProperty: __webpack_require__(172).f});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(167), 'Object', {defineProperties: __webpack_require__(208)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 19.1.2.6 Object.getOwnPropertyDescriptor(O, P)
	var toIObject                 = __webpack_require__(193)
	  , $getOwnPropertyDescriptor = __webpack_require__(212).f;

	__webpack_require__(217)('getOwnPropertyDescriptor', function(){
	  return function getOwnPropertyDescriptor(it, key){
	    return $getOwnPropertyDescriptor(toIObject(it), key);
	  };
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(217)('getPrototypeOf', function(){
	  return function getPrototypeOf(it){
	    return $getPrototypeOf(toObject(it));
	  };
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 19.1.2.7 Object.getOwnPropertyNames(O)
	__webpack_require__(217)('getOwnPropertyNames', function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(174)
	  , meta     = __webpack_require__(183).onFreeze;

	__webpack_require__(217)('freeze', function($freeze){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(217)('seal', function($seal){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(217)('preventExtensions', function($preventExtensions){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(217)('isFrozen', function($isFrozen){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(217)('isSealed', function($isSealed){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(217)('isExtensible', function($isExtensible){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(181)(Function.call, __webpack_require__(212).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
	        buggy = !(test instanceof Array);
	      } catch(e){ buggy = true; }
	      return function setPrototypeOf(O, proto){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classof = __webpack_require__(236)
	  , test    = {};
	test[__webpack_require__(186)('toStringTag')] = 'z';
	if(test + '' != '[object z]'){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dP         = __webpack_require__(172).f
	  , createDesc = __webpack_require__(178)
	  , has        = __webpack_require__(166)
	...
	// 19.2.4.2 name
	NAME in FProto || __webpack_require__(167) && dP(FProto, NAME, {
	  configurable: true,
	  get: function(){
	    try {
	      var that = this
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObject       = __webpack_require__(174)
	  , getPrototypeOf = __webpack_require__(220)
	  , HAS_INSTANCE   = __webpack_require__(186)('hasInstance')
	  , FunctionProto  = Function.prototype;
	// 19.2.3.6 Function.prototype[@@hasInstance](V)
	if(!(HAS_INSTANCE in FunctionProto))__webpack_require__(172).f(FunctionProto, HAS_INSTANCE, {value: function(O){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $parseInt = __webpack_require__(165).parseInt
	  , $trim     = __webpack_require__(244).trim
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export     = __webpack_require__(169)
	  , $parseFloat = __webpack_require__(247);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $parseFloat = __webpack_require__(165).parseFloat
	  , $trim       = __webpack_require__(244).trim;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global            = __webpack_require__(165)
	  ...
	  , fails             = __webpack_require__(168)
	  , gOPN              = __webpack_require__(211).f
	  , gOPD              = __webpack_require__(212).f
	  , dP                = __webpack_require__(172).f
	  , $trim             = __webpack_require__(244).trim
	  , NUMBER            = 'Number'
	  ...
	  , BROKEN_COF        = cof(__webpack_require__(207)(proto)) == NUMBER
	...
	if(!$Number(' 0o1') || !$Number('0b1') || $Number('+0x1')){
	  ...
	  for(var keys = __webpack_require__(167) ? gOPN(Base) : (
	    // ES3:
...
/***/ function(module, exports, __webpack_require__) {
	...
	) || !__webpack_require__(168)(function(){
	  // V8 ~ Android 4.3-
	  $toFixed.call({});
	})), 'Number', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export   = __webpack_require__(169)
	  , _isFinite = __webpack_require__(165).isFinite;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(244)('trim', function($trim){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
	__webpack_require__(171)(IteratorPrototype, __webpack_require__(186)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('anchor', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('big', function(createHTML){
	  return function big(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('blink', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('bold', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('fixed', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('fontcolor', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('fontsize', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('italics', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('link', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('small', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('strike', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('sub', function(createHTML){
	  return function sub(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('sup', function(createHTML){
	  return function sup(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * __webpack_require__(168)(function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(new Date(NaN) + '' != INVALID_DATE){
	  __webpack_require__(179)(DateProto, TO_STRING, function toString(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TO_PRIMITIVE = __webpack_require__(186)('toPrimitive')
	  , proto        = Date.prototype;

	if(!(TO_PRIMITIVE in proto))__webpack_require__(171)(proto, TO_PRIMITIVE, __webpack_require__(319));
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (__webpack_require__(194) != Object || !__webpack_require__(329)(arrayJoin)), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (fails(function(){
	  ...
	  test.sort(null);
	  // Old WebKit
	}) || !__webpack_require__(329)($sort)), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export  = __webpack_require__(169)
	  , $forEach = __webpack_require__(333)(0)
	  , STRICT   = __webpack_require__(329)([].forEach, true);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(169)
	  , $map    = __webpack_require__(333)(1);

	$export($export.P + $export.F * !__webpack_require__(329)([].map, true), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(169)
	  , $filter = __webpack_require__(333)(2);

	$export($export.P + $export.F * !__webpack_require__(329)([].filter, true), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(169)
	  , $some   = __webpack_require__(333)(3);

	$export($export.P + $export.F * !__webpack_require__(329)([].some, true), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(169)
	  , $every  = __webpack_require__(333)(4);

	$export($export.P + $export.F * !__webpack_require__(329)([].every, true), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * !__webpack_require__(329)([].reduce, true), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * !__webpack_require__(329)([].reduceRight, true), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (NEGATIVE_ZERO || !__webpack_require__(329)($native)), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(347)('copyWithin');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(169)
	  , $find   = __webpack_require__(333)(5)
	  , KEY     = 'find'
	  , forced  = true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(169)
	  , $find   = __webpack_require__(333)(6)
	  , KEY     = 'findIndex'
	  , forced  = true;
	// Shouldn't skip holes
	if(KEY in [])Array(1)[KEY](function(){ forced = false; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(__webpack_require__(167) && (!CORRECT_NEW || __webpack_require__(168)(function(){
	  re2[__webpack_require__(186)('match')] = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var define = function(fn){
	  __webpack_require__(179)(RegExp.prototype, TO_STRING, fn, true);
	};

	// 21.2.5.14 RegExp.prototype.toString()
	if(__webpack_require__(168)(function(){ return $toString.call({source: 'a', flags: 'b'}) != '/a/b'; })){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 21.2.5.3 get RegExp.prototype.flags()
	if(__webpack_require__(167) && /./g.flags != 'g')__webpack_require__(172).f(RegExp.prototype, 'flags', {
	  configurable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@match logic
	__webpack_require__(361)('match', 1, function(defined, MATCH, $match){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@replace logic
	__webpack_require__(361)('replace', 2, function(defined, REPLACE, $replace){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@search logic
	__webpack_require__(361)('search', 1, function(defined, SEARCH, $search){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@split logic
	__webpack_require__(361)('split', 2, function(defined, SPLIT, $split){
	  'use strict';
	  var isRegExp   = __webpack_require__(295)
	    , _split     = $split
	    , $push      = [].push
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY            = __webpack_require__(189)
	  ...
	  , isObject           = __webpack_require__(174)
	  , aFunction          = __webpack_require__(182)
	  , anInstance         = __webpack_require__(366)
	  , forOf              = __webpack_require__(367)
	...
	var USE_NATIVE = !!function(){
	  try {
	    ...
	    var promise     = $Promise.resolve(1)
	      , FakePromise = (promise.constructor = {})[__webpack_require__(186)('species')] = function(exec){ exec(empty, empty); };
	...
	__webpack_require__(185)($Promise, PROMISE);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dP          = __webpack_require__(172).f
	  ...
	  , step        = __webpack_require__(355)
	  , setSpecies  = __webpack_require__(353)
	  , DESCRIPTORS = __webpack_require__(167)
	  , fastKey     = __webpack_require__(183).fastKey
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $WeakMap = module.exports = __webpack_require__(374)('WeakMap', wrapper, methods, weak, true, true);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var redefineAll       = __webpack_require__(371)
	  , getWeak           = __webpack_require__(183).getWeak
	  , anObject          = __webpack_require__(173)
	  , isObject          = __webpack_require__(174)
	  , anInstance        = __webpack_require__(366)
	  , forOf             = __webpack_require__(367)
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var weak = __webpack_require__(377);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export      = __webpack_require__(169)
	  , $typed       = __webpack_require__(380)
	  , buffer       = __webpack_require__(381)
	  , anObject     = __webpack_require__(173)
	  , toIndex      = __webpack_require__(200)
	  , toLength     = __webpack_require__(198)
	  , isObject     = __webpack_require__(174)
	  , ArrayBuffer  = __webpack_require__(165).ArrayBuffer
	  , speciesConstructor = __webpack_require__(368)
	...
	$export($export.P + $export.U + $export.F * __webpack_require__(168)(function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(165)
	  ...
	  , gOPN           = __webpack_require__(211).f
	  , dP             = __webpack_require__(172).f
	  , arrayFill      = __webpack_require__(349)
	  , setToStringTag = __webpack_require__(185)
	  , ARRAY_BUFFER   = 'ArrayBuffer'
	  , DATA_VIEW      = 'DataView'
	  , PROTOTYPE      = 'prototype'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(169);
	$export($export.G + $export.W + $export.F * !__webpack_require__(380).ABV, {
	  DataView: __webpack_require__(381).DataView
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(384)('Int8', 1, function(init){
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(__webpack_require__(167)){
	  var LIBRARY             = __webpack_require__(189)
	    ...
	    , ctx                 = __webpack_require__(181)
	    , anInstance          = __webpack_require__(366)
	    , propertyDesc        = __webpack_require__(178)
	    , hide                = __webpack_require__(171)
	    , redefineAll         = __webpack_require__(371)
	    , toInteger           = __webpack_require__(199)
	    , toLength            = __webpack_require__(198)
	    ...
	    , speciesConstructor  = __webpack_require__(368)
	    , ArrayIterators      = __webpack_require__(354)
	    , Iterators           = __webpack_require__(290)
	    , $iterDetect         = __webpack_require__(326)
	    , setSpecies          = __webpack_require__(353)
	    , arrayFill           = __webpack_require__(349)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(384)('Uint8', 1, function(init){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(384)('Int16', 2, function(init){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(384)('Uint16', 2, function(init){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(384)('Int32', 4, function(init){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(384)('Uint32', 4, function(init){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(384)('Float32', 4, function(init){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(384)('Float64', 8, function(init){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export   = __webpack_require__(169)
	  , aFunction = __webpack_require__(182)
	  , anObject  = __webpack_require__(173)
	  , rApply    = (__webpack_require__(165).Reflect || {}).apply
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export    = __webpack_require__(169)
	  ...
	  , rConstruct = (__webpack_require__(165).Reflect || {}).construct;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(291)(Enumerate, 'Object', function(){
	  var that = this
	    , keys = that._k
	    , key;
	  do {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gOPD           = __webpack_require__(212)
	  , getPrototypeOf = __webpack_require__(220)
	  , has            = __webpack_require__(166)
	  , $export        = __webpack_require__(169)
	  , isObject       = __webpack_require__(174)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export  = __webpack_require__(169)
	  , getProto = __webpack_require__(220)
	  , anObject = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gOPN     = __webpack_require__(211)
	  , gOPS     = __webpack_require__(204)
	  , anObject = __webpack_require__(173)
	  , Reflect  = __webpack_require__(165).Reflect;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export   = __webpack_require__(169)
	  , $includes = __webpack_require__(197)(true);
	...
	__webpack_require__(347)('includes');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(169)
	  , $at     = __webpack_require__(288)(true);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(244)('trimLeft', function($trim){
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	// https://github.com/sebmarkbage/ecmascript-string-left-right-trim
	__webpack_require__(244)('trimRight', function($trim){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export     = __webpack_require__(169)
	  ...
	  , toLength    = __webpack_require__(198)
	  , isRegExp    = __webpack_require__(295)
	  , getFlags    = __webpack_require__(357)
	...
	__webpack_require__(291)($RegExpStringIterator, 'RegExp String', function next(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export        = __webpack_require__(169)
	  , ownKeys        = __webpack_require__(404)
	  , toIObject      = __webpack_require__(193)
	  , gOPD           = __webpack_require__(212)
	  , createProperty = __webpack_require__(324);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getKeys   = __webpack_require__(191)
	  , toIObject = __webpack_require__(193)
	  , isEnum    = __webpack_require__(205).f;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(167) && $export($export.P + __webpack_require__(423), 'Object', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(189)|| !__webpack_require__(168)(function(){
	  var K = Math.random();
	  // In FF throws only define methods
	  __defineSetter__.call(null, K, function(){ /* empty */});
	  delete __webpack_require__(165)[K];
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S, 'System', {global: __webpack_require__(165)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export   = __webpack_require__(169)
	  , microtask = __webpack_require__(370)()
	  , process   = __webpack_require__(165).process
	  , isNode    = __webpack_require__(195)(process) == 'process';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export     = __webpack_require__(169)
	  ...
	  , core        = __webpack_require__(170)
	  , microtask   = __webpack_require__(370)()
	  , OBSERVABLE  = __webpack_require__(186)('observable')
	  , aFunction   = __webpack_require__(182)
	  , anObject    = __webpack_require__(173)
	  , anInstance  = __webpack_require__(366)
	  , redefineAll = __webpack_require__(371)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global     = __webpack_require__(165)
	  , $export    = __webpack_require__(169)
	  , invoke     = __webpack_require__(239)
	  , partial    = __webpack_require__(450)
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var path      = __webpack_require__(451)
	  , invoke    = __webpack_require__(239)
	  , aFunction = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(455)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(170).RegExp.escape;
