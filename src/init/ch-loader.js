...
// (function(){var script=document.createElement('script');script.src='//dl.dropboxusercontent.com/u/37122446/chatango/portal/loader.js';script.type='text/javascript';document.getElementsByTagName('head')[0].appendChild(script);})();
...
(
    function()
    {
	    ...
	    // initialCSSTag.innerHTML = 'body{margin: 0px;padding:0px;}@-webkit-keyframes loader_spinner {from {-webkit-transform: rotateZ(0deg);}to {-webkit-transform: rotateZ(360deg);}}@-moz-keyframes loader_spinner {from {transform: rotateZ(0deg);}to {transform: rotateZ(360deg);}}@-o-keyframes loader_spinner {from {-o-transform: rotateZ(0deg);}to {-o-transform: rotateZ(360deg);}}@-ms-keyframes loader_spinner {from {-ms-transform: rotateZ(0deg);}to {-ms-transform: rotateZ(360deg);}}@keyframes loader_spinner {from {transform: rotateZ(0deg);}to {transform: rotateZ(360deg);}}.PortalApp {position: absolute;height: 100%;width: 100%;top: 0px;left: 0px;-moz-box-sizing: border-box;box-sizing: border-box;}.PortalApp:not([data-loaded=true]) {overflow: hidden;}.PortalApp .loadSpinner {display: inline-flex;-webkit-flex-direction: column;flex-direction: column;-webkit-justify-content: center;justify-content: center;-webkit-align-items: center;align-items: center;}.PortalApp .loadSpinner > svg {-webkit-flex-shrink: 1;flex-shrink: 1;}.PortalApp .loadSpinner svg {-webkit-animation: loader_spinner 2s infinite ease-in-out;-moz-animation: loader_spinner 2s infinite ease-in-out;-o-animation: loader_spinner 2s infinite ease-in-out;-ms-animation: loader_spinner 2s infinite ease-in-out;animation: loader_spinner 2s infinite ease-in-out;}.PortalApp .loaderSpinner.large > svg {width: 60%;height: 60%;}.PortalApp .loaderSpinner:not(.large) > svg {width: 30px;height: 30px;}.PortalApp .cover {position: absolute;z-index: 200;height: 100%;width: 100%;top: 0px;left: 0px;background-color: white;}';
	    // appWrapper.appendChild(initialCSSTag);
        // var jqScript=document.createElement('script');
        // jqScript.src='//dl.dropboxusercontent.com/u/37122446/chatango/portal/jquery.js';
        // jqScript.type='text/javascript';
        // var loaderScript=document.createElement('script');
        // loaderScript.src='//dl.dropboxusercontent.com/u/37122446/chatango/portal/loader.js';
