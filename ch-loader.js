...
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"1":"core"}[chunkId]||chunkId) + ".js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _publicPath = __webpack_require__(1);
	...
	(function () {
	    ...
	    finalCSSLink.setAttribute('href', _publicPath.publicPath + './common.css');
	    document.getElementsByTagName('head')[0].appendChild(finalCSSLink);

	    var jqScript = document.createElement('script');
	    jqScript.src = _publicPath.publicPath + './jquery.js';
	    ...
	    (function initialise() {
	        ...
	        __webpack_require__.e/* nsure */(1, function (require) {
	            module.exports.info = __webpack_require__(112);
	            module.exports.resources = __webpack_require__(96);
	            module.exports.types = __webpack_require__(2);
	            ...
	            module.exports.coreInstance = new module.exports.types.Core(config, prioritiseUserConfig, appWrapper, function () {
	                appWrapper.removeChild(loader);
	            });
	        });
	    })();
